...
public class CustomerServiceImplWithSpringData implements CustomerService {
    ...
    @Override
    public Page<Customer> search(String keyword, Pageable pageInfo) throws Exception {
        Page<Customer> customerPage = customerRepository.findAllByNameContainsOrEmailContainsOrAddressContains(keyword, keyword, keyword, pageInfo);
    ...
    public Customer save(Customer customer) throws Exception {
        if (customer == null) {
            throw new Exception("Wrong customer info!");
        }
